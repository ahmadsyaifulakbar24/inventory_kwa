...
class PengadaanReviewResource extends JsonResource
{
    public function toArray($request)
    {
        return [
            ...
            'first_approved_at' => \Carbon\Carbon::parse($this->first_approved_at)->timezone('Asia/Jakarta')->format('Y-m-d H:i:s'),
            'second_approved_at' => \Carbon\Carbon::parse($this->second_approved_at)->timezone('Asia/Jakarta')->format('Y-m-d H:i:s'),
            'status' => $this->status,
