...
class Project extends Model 
{
    ...
    {
        return $this->belongsToMany('App\Models\Item', 'project_items', 'project_id', 'item_id')->withPivot('id', 'quantity', 'status', 'category', 'supplier_id', 'image1', 'image2', 'url', 'date_approved', 'created_at');
    }
