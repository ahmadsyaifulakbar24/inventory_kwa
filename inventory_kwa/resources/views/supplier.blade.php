...
@section('content')
	<div class="container">
		<div class="mb-5 hide" id="data">
			<h5 class="mb-3">Daftar Supplier</h5>
		...
		<div class="compose">
			<a href="{{url('create/supplier')}}" class="btn btn-primary d-flex align-items-center shadow px-3" style="border-radius:100px">
				<i class="mdi mdi-plus-thick mdi-18px"></i> Tambah Supplier
			</a>
		</div>
	</div>
