		...
		<form id="form" enctype="multipart/form-data" class="hide">
			<div class="form-group row">
				...
				<div class="col-xl-5 col-lg-6 col-md-7">
					...
					<div class="invalid-feedback" id="item_id-feedback">Pilih barang</div>
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-xl-5 col-lg-6 col-md-7">
					...
					<div class="invalid-feedback" id="sto_id-feedback">Pilih STO</div>
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-xl-5 col-lg-6 col-md-7">
					...
					<div class="invalid-feedback" id="jenis-feedback">Pilih jenis</div>
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-xl-5 col-lg-6 col-md-7">
					...
					<div class="invalid-feedback" id="keterangan_id-feedback">Pilih keterangan</div>
				</div>
			</div>
