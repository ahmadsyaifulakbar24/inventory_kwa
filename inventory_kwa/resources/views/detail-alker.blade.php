	...
	<div class="container">
		...
		<div id="data" class="hide">
			...
			<div class="form-group row">
				...
				<div class="col-xl-5 col-lg-6 col-md-7">
					<label class="col-form-label font-weight-bold" id="kegunaan"></label>
				</div>
			</div>
			<div class="form-group row">
				<label for="status" class="col-xl-3 col-lg-4 col-md-5 col-form-label">Status</label>
				<div class="col-xl-5 col-lg-6 col-md-7">
					<label class="col-form-label font-weight-bold" id="status"></label>
				</div>
			</div>
			<div class="form-group row mb-5">
				<label for="qrcode" class="col-xl-3 col-lg-4 col-md-5 col-form-label">QR Code</label>
				<div class="col-xl-5 col-lg-6 col-md-7" id="qrcode"></div>
			</div>
		</div>
